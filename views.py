...
def detail_pubyear(request, publish_year):
    ...
    context = {'detail_pubyear' : detail_pubyear,}
    return HttpResponse(template.render(context, request))
...
def detail_genre(request, genre):
    ...
    context = {'detail_genre' : detail_genre,}
    return HttpResponse(template.render(context, request))
...
def detail_language(request, language):
    ...
    context = {'detail_language' : detail_language,}
    return HttpResponse(template.render(context, request))
...
def detail_subject(request, subject):
    ...
    context = {'detail_subject' : detail_subject,}
    return HttpResponse(template.render(context, request))
...
def detail_worktypes(request, work_type):
    ...
    context = {'detail_worktypes' : detail_worktypes,}
    return HttpResponse(template.render(context, request))
...
def detail_volume(request, volume):
    ...
    context = {'detail_volumes' : detail_volumes,}
    return HttpResponse(template.render(context, request))
...
def detail_copycat(request, copycat):
    ...
    context = {'detail_copycats' : detail_copycats,}
    return HttpResponse(template.render(context, request))
...
def detail_size(request, size):
    ...
    context = {'detail_sizes' : detail_sizes,}
    return HttpResponse(template.render(context, request))
...
def detail_ISBN(request, ISBN):
    ...
    context = {'detail_ISBNs' : detail_ISBNs,}
    return HttpResponse(template.render(context, request))
...
def volume_chart(request):
    ...
    for xlang in queryset:
      ...
      data.append(xlang['langcount'])
    return render(request, 'chart_volume.html',{'labels' : labels,'data' : data,})
...
def isbn_chart(request):
    ...
    for xlang in queryset:
      ...
      data.append(xlang['langcount'])
    return render(request, 'chart_isbn.html',{'labels' : labels,'data' : data,})
...
def size_chart(request):
    ...
    for xlang in queryset:
      ...
      data.append(xlang['langcount'])
    return render(request, 'chart_size.html',{'labels' : labels,'data' : data,})
